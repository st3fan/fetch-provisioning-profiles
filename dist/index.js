...
const supportedProfileTypes = [
    ...
    appstoreconnect_1.ProfileType.MAC_APP_DEVELOPMENT,
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const client = appstoreconnect_1.createAppStoreConnectClientFromInputs();
            ...
            for (const identifier of bundleIdentifiers) {
                ...
                if (profileType.startsWith('IOS_APP_') && ![bundleIds_1.BundleIdPlatform.IOS, bundleIds_1.BundleIdPlatform.UNIVERSAL].includes(bundleId.attributes.platform)) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ProfileType = exports.ProfileState = void 0;
var ProfileState;
...
(function (ProfileType) {
    ProfileType["IOS_APP_DEVELOPMENT"] = "IOS_APP_DEVELOPMENT";
    ProfileType["IOS_APP_STORE"] = "IOS_APP_STORE";
    ProfileType["IOS_APP_ADHOC"] = "IOS_APP_ADHOC";
    ProfileType["IOS_APP_INHOUSE"] = "IOS_APP_INHOUSE";
    ProfileType["MAC_APP_DEVELOPMENT"] = "MAC_APP_DEVELOPMENT";
    ProfileType["MAC_APP_STORE"] = "MAC_APP_STORE";
    ProfileType["MAC_APP_DIRECT"] = "MAC_APP_DIRECT";
    ProfileType["TVOS_APP_DEVELOPMENT"] = "TVOS_APP_DEVELOPMENT";
    ProfileType["TVOS_APP_STORE"] = "TVOS_APP_STORE";
    ProfileType["TVOS_APP_ADHOC"] = "TVOS_APP_ADHOC";
    ProfileType["TVOS_APP_INHOUSE"] = "TVOS_APP_INHOUSE";
    ProfileType["MAC_CATALYST_APP_DEVELOPMENT"] = "MAC_CATALYST_APP_DEVELOPMENT";
    ProfileType["MAC_CATALYST_APP_STORE"] = "MAC_CATALYST_APP_STORE";
    ProfileType["MAC_CATALYST_APP_DIRECT"] = "MAC_CATALYST_APP_DIRECT";
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.DefaultAppStoreConnectClient = void 0;
...
class DefaultAppStoreConnectClient {
    ...
    listProfiles() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.list(client, `https://api.appstoreconnect.apple.com/v1/profiles`);
        });
    }
    getProfile(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = this.createClient();
            return yield this.get(client, `https://api.appstoreconnect.apple.com/v1/profiles/${id}`);
        });
    }
    createProfile(createRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = this.createClient();
            return yield this.create(client, 'https://api.appstoreconnect.apple.com/v1/profiles', createRequest);
        });
    }
    listCertificates() {
        return __awaiter(this, void 0, void 0, function* () {
            const client = this.createClient();
            return yield this.list(client, `https://api.appstoreconnect.apple.com/v1/certificates`);
        });
    }
    listBundleIds() {
        return __awaiter(this, void 0, void 0, function* () {
            const client = this.createClient();
            return yield this.list(client, `https://api.appstoreconnect.apple.com/v1/bundleIds`);
        });
    }
    getBundleId(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    createClient() {
        ...
        const handlers = [new auth_1.BearerCredentialHandler(token)];
        return new http_client_1.HttpClient('devbotsxyz/fetch-provisioning-profiles', handlers);
    }
    list(client, url) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield client.getJson(url);
    ...
    create(client, url, createRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield client.postJson(url, createRequest);
...
exports.DefaultAppStoreConnectClient = DefaultAppStoreConnectClient;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.BundleIdPlatform = exports.ProfileType = exports.createAppStoreConnectClientFromInputs = void 0;
const core = __importStar(__webpack_require__(186));
const client_1 = __webpack_require__(476);
const profiles_1 = __webpack_require__(208);
Object.defineProperty(exports, "ProfileType", { enumerable: true, get: function () { return profiles_1.ProfileType; } });
const bundleIds_1 = __webpack_require__(661);
Object.defineProperty(exports, "BundleIdPlatform", { enumerable: true, get: function () { return bundleIds_1.BundleIdPlatform; } });
function credentialsFromInputs() {
...
function createAppStoreConnectClientFromInputs() {
    return client_1.DefaultAppStoreConnectClient.create(credentialsFromInputs());
}
exports.createAppStoreConnectClientFromInputs = createAppStoreConnectClientFromInputs;
...
var BundleIdPlatform;
(function (BundleIdPlatform) {
    BundleIdPlatform["IOS"] = "IOS";
    BundleIdPlatform["MAC_OS"] = "MAC_OS";
    BundleIdPlatform["UNIVERSAL"] = "UNIVERSAL"; // TODO This is not documented
})(BundleIdPlatform = exports.BundleIdPlatform || (exports.BundleIdPlatform = {}));
